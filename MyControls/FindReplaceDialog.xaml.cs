...
namespace RootNS.MyControls
{
    ...
    public partial class FindReplaceDialog : Window
    {
        ...
        private void CheckBox_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            cb.IsChecked = Convert.ToBoolean(Settings.Get(Gval.MaterialBook, string.Format("{0}_{1}", this.GetType().Name, cb.Name)));
        ...
        private void CheckBox_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                CheckBox cb = sender as CheckBox;
                Settings.Set(Gval.MaterialBook, string.Format("{0}_{1}", this.GetType().Name, cb.Name), cb.IsChecked);
            }
        }
